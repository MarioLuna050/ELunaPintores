...
@section('content')
 ...
 <body class="salvador" background="images\bight.png">
<a id="volver" href="{{action('EstructurasDeControl@inicio')}}"><img src="images\atras.png" alt="" width="60px"></a>
<header>
    <h1>SALVADOR DALÍ</h1>
</header>
<main>
    <img id="perfil" src="images\salvador.jpg" alt="">
    <h4>Biografía</h4>
    <p>Salvador Dalí fue un polifacético artista español del siglo XX (nació el 11 de mayo de 1904 y murió el 23 de enero de 1989) conocido principalmente por:
...
<img id="bien" src="images\salvador1.jpg" alt="">
<h5>SUEÑO CAUSADO POR EL VUELO DE UNA ABEJA ALREDEDOR DE UNA GRANADA UN SEGUNDO ANTES DE DESPERTAR</h5>
<p>Es un famoso cuadro del pintor español Salvador Dalí realizado en 1944. Está hecho mediante la técnica del óleo sobre tabla, es de estilo surrealista y sus medidas son 51 x 41 cm. Se conserva en Madrid, en el Museo Thyssen-Bornemisza.
...
<br>
<br>
<img id="mal" src="images\salvador2.jpg" alt="">
<h5>LOS ELEFANTES</h5>
<p>También conocido por su título en inglés "The Elephants". Pintado al óleo sobre tela, el año 1948. Este cuadro recupera las figuras absolutamente fascinantes y oníricas que Dalí había creado hace 4 años, pero esta vez son protagonistas de la obra</p>
<img id="bien"src="images\salvador3.jpg" alt="">
<h5>CISNES QUE SE REFLEJAN COMO ELEFANTES</h5>
<p>Cisnes que se reflejan como elefantes es una pintura por el pintor surrealista español Salvador Dalí. El cuadro fue pintado durante su período paranoico-crítico, y contiene una de las imágenes dobles más conocidas que formaron una parte importante de este período.
...
<br>
<br>
<img id="bien"src="images\salvador5.jpg" alt="">
<h5>LA TENTACIÓN DE SAN ANTONIO</h5>
<p>Esta es una de las obras más representativas del surrealismo español, fue pintada en 1946, al óleo sobre tela, con medidas 90 x 120 cm.
