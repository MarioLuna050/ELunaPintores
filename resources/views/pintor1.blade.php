...
@section('content')
    ...
    <main>
        ...
        <ul >
            <li>Género: Pintura mural</li>
            <li>Obras: Epopeya del pueblo mexicano, La tierra fecunda, Río Juchitán.</li>
            <li>Nombre: Diego María de la Concepción Juan Nepomuceno Estanislao de la Rivera y Barrientos Acosta y Rodríguez</li>
            <li>Cónyuges: Angelina Beloff (1911-1921), Guadalupe Marín (1922-1927), Frida Kahlo (1929-1939), Emma Hurtado (1955-1957)</li>
            <li>Hijos: Ruth, Marika, Guadalupe, Diego</li>
        </ul>
        <br>
        <br>
        <br>
    ...
    <img id="normales1" src="images\diegorivera1.jpg" alt="">
    <h5>LA VENDEDORA DE LAS FLORES.</h5>
    <p>En sus últimas pinturas Rivera desarrollo un estilo indigenista y social de gran atractivo popular.
    ...
    <img  id="normales" src="images\diegorivera2.jpg" alt="">
    <h5>CASA SOBRE EL PUENTE.</h5>
    <p>El pintor representa, al fondo, la Casa Arents, que actualmente aloja al Museo Brangwyn;
        en el costado izquierdo, un muro del palacio Gruuthuse del siglo XV; y a través del puente,
        el fluir constante de las aguas del canal Reie. La evocación de la nostalgia simbolista de la ciudad muerta,
        con sus edificios deteriorados por el tiempo, está lograda en este óleo a través de diversas tonalidades rojizas que remiten al otoño,
        resaltadas por contraste con las zonas lumínicas: el cielo, la fachada de la casa, así como la luz que se vislumbra al final del acueducto.
        La tranquilidad de las aguas del canal, que incluyen el reflejo de la escena, se ve perturbada por el goteo proveniente de una de las gárgolas del palacio de la izquierda,
        formando en la superficie ondas concéntricas; especialmente en esta área,
        las pinceladas tienen apariencia de escurrimientos y manchones para lograr los efectos. </p>

    <img  id="normales1" src="images\diegorivera3.jpg" alt="">
    <h5>LA MUJER DEL POZO.</h5>
    <p>Se apega al cubismo sintético. Esta obra se distingue al resto debido a sus elementos icono-gráficos representativos del contexto de la Revolución Mexicana, tales como el rifle, el cinturón, el güaje, el sombrero y el sarape. De fondo se aprecia el Valle de México con sus volcanes, los cuales representan la totalidad de su país.
    ...
    <h5>SUEÑO DE UNA TARDE DOMINICAL EN LA ALAMEDA CENTRAL.</h5>
    <p>SUEÑO DE UNA TARDE DOMINICAL EN LA ALAMEDA CENTRAL
        <br>
    ...
    <img  id="largas" src="images\diegorivera4.jpg" alt="">
    <h5>LA EPOPEYA DEL PUEBLO MEXICANO.</h5>
    <p>276 metros cuadrados de los muros sur, poniente y norte de la escalera principal del Palacio Nacional. Un atajo visual al pasado remoto y al futuro impredecible, composición de colores y formas que exponen: el misticismoprecolombino, el salvajismo irracional del conquistador, las luchas por la libertad contra el invasor y el opresor y la construcción del porvenir inconcluso.</p>
    <img  id="largas" src="images\diegorivera5.jpg" alt="">
@stop
@section('footer')
    @parent
@stop
